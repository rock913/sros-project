...
"""
    ...
    test_env_path = PROJECT_ROOT / ".test_env"
    test_env_path.write_text(test_env_content.strip(), encoding="utf-8")
    ...
    for var_name, expected_value in expected_vars.items():
        ...
        if actual_value == expected_value:
            ...
            print(
                f"✗ {var_name} not loaded correctly. Expected: {expected_value}, Got: {actual_value}"
            )
            all_passed = False
