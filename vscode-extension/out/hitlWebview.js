...
exports.generateHITLDecisionCardHTML = generateHITLDecisionCardHTML;
/**
 * Main entry point for generating HITL decision card HTML
 */
function generateHITLDecisionCardHTML(request) {
 ...
 */
function generateQueryApprovalCard(request) {
 ...
 */
function generatePaperSelectionCard(request) {
    const { context, request_id, timeout_seconds } = request;
 ...
 */
function generateReportRevisionCard(request) {
    const { context, request_id, timeout_seconds } = request;
 ...
 */
function generateGenericCard(request) {
...
//# sourceMappingURL=hitlWebview.js.map